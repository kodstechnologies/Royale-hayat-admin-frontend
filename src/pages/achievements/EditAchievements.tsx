...
const EditAchievements = () => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          status: achievement.status === "published" ? "show" : "hide",
          imageFile: null,
          imageUrl: achievement.image || "",
          arabicEmployeeName: achievement.arabicEmployeeName || "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        status === "show"
          ? "Achievement updated and published successfully!"
          : "Achievement updated and hidden successfully!"
      );
      navigate("/achievements");
    } catch (error: unknown) {
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-800">
                    {activeTab === "english" ? "Edit Achievement" : "تعديل الإنجاز"}
                  </h2>
                  <p className="text-sm text-slate-500 mt-1">
                    {activeTab === "english" 
                      ? "Update the employee achievement record" 
                      : "تحديث سجل إنجاز الموظف"}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-5">
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700">
                      {activeTab === "english" ? "Achievement Title" : "عنوان الإنجاز"} <span className="text-red-500">*</span>
                    </label>
                    <Input
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                >
                  ...
                  {saving 
                    ...
                    : (activeTab === "english" ? "Save Changes" : "حفظ التغييرات")}
                </Button>
              </div>
            </div>
          </div>
